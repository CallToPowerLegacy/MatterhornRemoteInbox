 ...
 */
public class SavePreferencesUI extends javax.swing.JFrame {

    private static final Logger logger = Logger.getLogger(SavePreferencesUI.class);

    public SavePreferencesUI() {
        initComponents();

        this.label_imgInfo.setText("");
        this.jLabel2.setText(Constants.getInstance().getLocalizedString("SavingPreferences"));
    ...
    private void initComponents() {
        ...
        try {
            ...
            logger.error("SavePreferencesUI::Constructor - IOException: " + ex.getMessage());
        ...
        jLabel2.setText("Saving preferences...");
        gridBagConstraints = new java.awt.GridBagConstraints();
