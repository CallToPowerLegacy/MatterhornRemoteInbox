...
echo Starting MHRI (this may take a minute)...
...
SET JAVA_CONF=-Dgosh.args="--noshutdown -c noop=true"
...
start javaw %JAVA_CONF% %FELIX_CONFIG_OPTS% %PAX_CONFMAN_OPTS% %PAX_LOGGING_OPTS% -jar %JARS% %FELIX_CACHE%
